        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('index.client')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>View USER</p>
                  </a>
                </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/UI/general.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Debit Transaction</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('create.credit')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Credit Transaction</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/UI/buttons.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Debit Transaction</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('index.credit')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Cradit Transaction</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('index.bank') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Bank</p>
                </a>
              </li>
